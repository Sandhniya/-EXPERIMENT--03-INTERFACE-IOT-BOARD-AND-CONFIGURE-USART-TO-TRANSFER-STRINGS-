...
#define PUTCHAR_PROTOTYPE int fputfc(int ch, FILE*f)
...
#define PUTCHAR_PROTOTYPE int __io_putchar(int ch)
 ...
 while (1)
  {
    /* USER CODE END WHILE */
       printf("your roll number and dept");
 HAL_Delay(1000);
    /* USER CODE BEGIN 3 */
  }
  /* USER CODE END 3 */
...
## Output screen shots of Serial port utility   :
 ...
 ![Screenshot 2024-09-16 091127](https://github.com/user-attachments/assets/0cdca83e-9f1b-4504-8af9-ebd63e7355dd)
